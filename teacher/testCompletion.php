...
$sql1 = "SELECT student.name,test_s.score,test_s.ttid, student.sid,answer FROM student LEFT JOIN test_s ON student.sid = test_s.sid AND ttid = $ttid WHERE class = $clid ";
