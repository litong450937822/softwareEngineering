        ...
        <table class="layui-table" lay-skin="line" style="margin: auto">
            ...
            while ($row = mysqli_fetch_assoc($rs)) {
                ...
                <tr>
                    ...
                    <td class="link discuss" data-dtid="<?php echo $row['dtid'] ?>"><?php echo $row['lastUpdateTime'] ?></td>
                    <td>
                        <button class="layui-btn layui-btn-sm work" data-method="confirmTrans" id="discuss"
